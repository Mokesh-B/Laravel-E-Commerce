                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="#">
                                            ...
                                            <img class="default-img" src="{{$article['image_url']}}" alt="product_image">
                                            <img class="hover-img" src="{{$article['image_url']}}" alt="product_image">
                                        </a>
                                    </div>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-action-1 show">
                                        <a href="{{ $article['link'] }}" target="_blank" aria-label="Read More" class="action-btn hover-up">+</a>
                                    </div>
                                </div>
                            </div>
                        </div>
